...
public final class FirefoxOptionsDecorator {
  ...
  static final BiConsumer<List<String>, FirefoxOptions> ADD_ARGUMENTS_DECORATOR = (
      arguments,
      firefoxOptions
    ) ->
    arguments.forEach(firefoxOptions::addArguments);
  static final BiConsumer<List<String>, FirefoxProfile> DOWNLOAD_FILE_DECORATOR = (
      arguments,
      firefoxProfile
    ) ->
    arguments
